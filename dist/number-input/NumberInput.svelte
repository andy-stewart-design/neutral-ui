...
import { NUMBER_GROUP_CONTEXT } from '../utils/ui';
const switchGroupContext = getContext(NUMBER_GROUP_CONTEXT);
const { activeValue, groupID, max, min, step, bigStep, placeholder, clampValue } = switchGroupContext;
