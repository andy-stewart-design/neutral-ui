<script>// TODO: Finish refactor of API
// ! I may actually going to need to keep the size declaration in the slider group
...
import { LIB_PREFIX, SLIDER_GROUP_CONTEXT, SLIDER_CONTEXT, getID } from '../utils/ui';
...
// });
setContext(SLIDER_GROUP_CONTEXT, { groupID: group });
